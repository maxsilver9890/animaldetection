...
const Landing = () => {
    return (
        ...
        <div className="site-mobile-menu site-navbar-target">
          ...
          <header className="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
            ...
            <div className="container-fluid">
              <div className="d-flex align-items-center">
                <div className="site-logo"><img src={process.env.PUBLIC_URL +"/imgs/dog.png"} alt="WildEye-Logo" height="50" width="50"/></div>
                <h5>&nbsp;PawVision</h5>
                <div>
              ...
              <div className="row align-items-center">
                <div className="col-lg-5 mr-auto" data-aos="fade-up">
                  <div className="owl-carousel slide-one-item-alt-text">
                    ...
                    <div className="slide-text">
                      <h1>PawVision</h1>
                      <p className="mb-5">PawVision is a system that utilizes the YOLOv11n (You Only Look Once) algorithm for object detection to protect and safeguard wildlife. YOLO is a real-time object detection algorithm that can quickly and accurately detect objects of interest in images or video frames.</p>
                    ...
                    <div className="slide-text">
                      <h1>YOLOv11?</h1>
                      <p className="mb-5">YOLOv11 is the latest version of the YOLO algorithm, which outperforms previous versions by introducing various modifications such as spatial attention, feature fusion, and context aggregation modules.<br/>These improvements result in faster and more accurate object detection, making YOLOv11 one of the key object detection algorithms in the field.</p>
                    </div>

                    <div className="slide-text">
                      <h1>YOLOv11 Nano?</h1>
                      <p className="mb-5">YOLOv11 Nano is a compact version of YOLO, designed with fewer parameters compared to other YOLOv10 models. Although it exhibits slightly lower accuracy, it is still practical for various applications. Its smaller size enables deployment on portable devices such as mobile phones, laptops, or other low-spec hardware devices.</p>
                    </div>
                ...
                <div className="col-lg-6 ml-auto"  data-aos="fade-up" data-aos-delay="100">
                  ...
                  <div className="owl-carousel slide-one-item-alt">
                    ...
                    <img src={process.env.PUBLIC_URL +"/imgs/slide3.png"} alt="YOLOv11" className="img-fluid"/>
                    <img src={process.env.PUBLIC_URL +"/imgs/slide4.png"}alt="YOLOv11n" className="img-fluid"/>
                  </div>
            ...
            <div className="container">
              <div className="row">
                ...
                <div className="col-lg-5 mr-auto mb-5"  data-aos="fade-up">
                  <div className="mb-5">
                    <h2 className="section-title">PawVision</h2>
                    <p className="black-text">PawVision is a wildlife species identification and offence registration web app.<br/>In the PawVision system, images captured by cameras or other devices are passed as input to the YOLO algorithm for object detection and recognition. By feeding the images through the trained YOLO model, PawVision can identify and localize wildlife species present in the images.</p>
                    <ul className="ul-check list-unstyled success">
                      ...
                      <li className="black-text">High Accuracy</li>
          ...
          <div className="site-section bg-primary" id="features-section" data-aos="fade">
            <div className="container">
              <div className="row justify-content-center">
                <div className="col-lg-6 mb-5 text-center">
                  <h2 className="section-title text-info ">Features</h2>
                </div>
              </div>
            </div>
            ...
            <div className="owl-carousel nonloop-block-14">
              ...
              <div className="service">
                <div>
                  ...
                  <h3>Ease Of Use</h3>
                  <p className="black-text"> Our interface is simple, elegant, and mobile-compatible, ensuring you have a seamless experience whether on your desktop or mobile.<br/><br/><br/><br/><br/></p>
                </div>
              </div>
              ...
              <div className="service">
                <div>
                  ...
                  <p className="black-text">This tool dramatically reduces the time and effort needed for image labeling, saving countless hours for researchers and volunteers. Get more done in less time and cut down operational costs significantly.Thus it dramatically reduces the cost to gather valuable information from wild habitats.</p>
                </div>
              </div>
              ...
              <div className="service">
                <div>
                  ...
                  <h3>High Accuracy</h3>
                  <p className="black-text">Achieve remarkable detection and classification results with an impressive accuracy rate of 82%. Our advanced algorithms guarantee reliable performance for real-world applications.<br/><br/><br/><br/></p>
                </div>
              </div>
              ...
              <div className="service">
                <div>
                  ...
                  <p className="black-text">Automatically identify and locate animal species in images with real-time results. From data collection to analysis, everything is streamlined and precise for optimal wildlife monitoring.<br/><br/><br/></p>
                </div>
              </div>
              ...
              <div className="service">
                <div>
                  ...
                  <p className="black-text">Easily identify 11 different animal species including Butterfly, Elephant, Tiger, Lion, Horse, Panda, Bear, Monkey, Dog, Deer, and Human. Get clear and confident classification every time.<br></br>Get clear and confident classification every time.<br/><br/></p>
                </div>
              </div>
              ...
              <div className="service">
                <div>
                  ...
                  <p className="black-text">Empower users to report animal-related offences by uploading images, geo-location data, or both. Help make wildlife conservation efforts more effective by gathering crucial evidence seamlessly.<br/><br/><br/><br/></p>
                </div>
              </div>
        ...
        <div className="site-section bg-primary" id="demo-section" data-aos="fade">
            <div className="container">
              <div className="row justify-content-center">
                <div className="col-lg-6 mb-5 text-center">
                  <h2 className="section-title text-info">Demo</h2>
                </div>
              </div>
            </div>
...
{/* 
                <div className="col-md-4 ">
                  ...
                  <ul className="list-unstyled footer-links">
                    ...
                    <li><a href="https://github.com/maxsilver9890" className="smoothscroll">Github</a></li>
                  </ul>
                </div> */}
                <div className="col-md-4">
  <h3  >Links</h3>
  <ul className="list-unstyled footer-links d-flex justify-content-between">
    <li><a href="#home-section" className="smoothscroll">Home</a></li>
    <li><a href="#features-section" className="smoothscroll">Features</a></li>
    <li><a href="#glance-section" className="smoothscroll">Glance</a></li>
    <li><a href="#demo-section" className="smoothscroll">Demo</a></li>
